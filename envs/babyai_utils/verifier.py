...
class GoToInstr(ActionInstr):
    ...
    def algebra(self, env, sample=False):
        if sample:
            if not self.desc.color and not self.desc.type:
                return 'goto_object'
            elif not self.desc.color:
                return 'goto_' + self.desc.type
            elif not self.desc.type:
                return 'goto_' + self.desc.color
            else:
                return env._rand_elem(['goto_' + self.desc.type + " AND " + 'goto_' + self.desc.color,
                                    'goto_' + self.desc.color + " AND " + 'goto_' + self.desc.type])
        else:
            if not self.desc.color and not self.desc.type:
                return 'goto_object'
            elif not self.desc.color:
                ...
                return 'goto_' + self.desc.type + " AND " + 'goto_' + self.desc.color
    ...
    def algebra(self, env, sample=False):
        if sample:
            if not self.desc.color and not self.desc.type:
                ...
                return 'pickup_' + self.desc.type
            elif not self.desc.type:
                return 'pickup_' + self.desc.color
            else:
                return env._rand_elem(['pickup_' + self.desc.type + " AND " + 'pickup_' + self.desc.color,
                                    'pickup_' + self.desc.color + " AND " + 'pickup_' + self.desc.type])
        else:
            if not self.desc.color and not self.desc.type:
                return 'pickup_object'
            elif not self.desc.color:
                ...
                return 'pickup_' + self.desc.type + " AND " + 'pickup_' + self.desc.color
